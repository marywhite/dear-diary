...
var gentle_touch = {
    ...
    emphasis: function (str){
        console.log(chalk.blue.bgWhite.bold(str));
    },
    invert: function (str){
...
var current_theme = function(){
    return get_theme(config.scheme());
};

module.exports.get_theme = get_theme;
module.exports.current_theme = current_theme;